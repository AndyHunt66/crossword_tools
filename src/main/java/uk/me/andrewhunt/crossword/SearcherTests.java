...
public class SearcherTests
{
    ...
    @Test
    @DisplayName("Anagram with Xword shorter than the target word")
    // abnir6:.r    -- Same as abnbisr5:.a... but the xword section only specifies as many characters as it needs to
